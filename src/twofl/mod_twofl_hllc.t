...
contains
  ...
  subroutine twofl_hllc_init()
    ...
    phys_get_wCD => twofl_get_wCD

  end subroutine twofl_hllc_init

  subroutine twofl_diffuse_hllcd(ixI^L,ixO^L,idim,wLC,wRC,fLC,fRC,patchf)
  ...
  end subroutine twofl_diffuse_hllcd

  subroutine twofl_get_lCD(wLC,wRC,fLC,fRC,cmin,cmax,idim,ixI^L,ixO^L, &
  ...
  end subroutine twofl_get_lCD

  subroutine twofl_get_wCD(wLC,wRC,whll,fRC,fLC,Fhll,patchf,lambdaCD,cmin,cmax,&
                    ixI^L,ixO^L,idim,f)
